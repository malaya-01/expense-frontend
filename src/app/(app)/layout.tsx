...
export default function AppLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="h-dvh overflow-hidden bg-[var(--ds-background-100)]">
      <AppSidebar />
      <main className="h-full overflow-y-auto overscroll-contain px-4 py-6 pb-24 transition-[margin-left] duration-200 sm:px-6 sm:py-8 md:ml-[var(--app-sidebar-offset)] md:pb-10">
