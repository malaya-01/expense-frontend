...
export function AccountKpiCard({
  ...
  return (
    <article
      className="min-w-0 overflow-hidden rounded-[12px] bg-[var(--ds-background-elevated)] p-3 ds-border sm:rounded-[16px] sm:p-5"
      data-kpi-card
    >
      ...
      <div className="mt-2 grid grid-cols-2 gap-2 border-t border-[color:color-mix(in_srgb,var(--ds-gray-1000)_8%,transparent)] pt-2 sm:mt-4 sm:gap-3 sm:pt-3">
        <div className="min-w-0">
          <p className="truncate text-[9px] uppercase tracking-[0.02em] text-[var(--ds-gray-700)] sm:text-[10px]">
            {footerLeft.label}
          </p>
